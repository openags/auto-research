...
class ChatWidget(QWidget):
    ...
    def add_message(self, text, is_user=True):
        ...
        bubble.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Minimum)  # ��Ϊ Minimum
        ...
        message.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Minimum)  # ��Ϊ Minimum
        ...
        message.setFixedHeight(content_height + 10)  # ����һЩ�߾�
